...
double integral_over_subdomain_f(IceMesh& n, INMOST::Tag& m)
{
        ...
        ++trianit)
    {
        if (trianit->GetStatus() != Element::Ghost)
        {
            ...
            double v0_x = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[0];
            double v0_y = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[1];
            double v1_x = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[2];
            double v1_y = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[3];
            double v2_x = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[4];
            double v2_y = trianit->RealArray(n.GetLocalBasisData().triangle_data.LocalNodeCoords)[5];
...
void INMOST_ICE::PrintErrors(IceMesh& n, INMOST::Tag& m_tag, INMOST::Tag& m_init_tag)
{
    BARRIER
