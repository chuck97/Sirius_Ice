...
c ... initialize the list
      ...
      nStep(1) = max(100.0, 7*log(real(nEStar)))
      nStep(2) = nStep(1) / 4
      nStep(3) = MaxE
      nStep(4) = 0
...
c     If(iPrint.GE.2) Call quality_plain(nE, L1E, L2E, qE)
...
c ... display output
 ...
 5004 Format('Maximum R/r =', E10.3,
     &       ' (R/r = 3 for equilateral tet), status.fd:', I5)
 ...
 5010 Format('Avg Quality is', E11.4, ',  Maximum R/r =', E11.4,
     &       ',  status.fd:', I5)
