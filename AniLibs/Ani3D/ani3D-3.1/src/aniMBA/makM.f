...
c ... color the points (fixed surface faces)
      If(ifXnode(status, ANIFixBoundaryFaces)) Then
         Do n = 1, nF
            Do i = 1, 3
               iP1 = IPF(i, n)
               Call addXnode(ICP(iP1), jTnode)
...
C ==============================================================
      ...
      Real*8  rOut, rIn, calVol, tri_area, calEdge
...
C ==============================================================
      ...
      sqr = tri_area(XY1, XY2, XY3) + tri_area(XY2, XY3, XY4)
     &    + tri_area(XY3, XY4, XY1) + tri_area(XY4, XY1, XY2)
...
c (Local variables)
      ...
      Do 10 n = 1, nF
         ...
         If(IPF(4, n).EQ.ic .OR. ic.LE.0) Then
            ...
            s = s + tri_area(XYP(1, iP1), XYP(1, iP2), XYP(1, iP3))
         End if
 10   Continue
