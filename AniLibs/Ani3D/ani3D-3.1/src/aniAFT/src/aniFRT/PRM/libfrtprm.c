...
double (*ani3d_2_X_comp_internal_fsize) (double, double, double) = NULL;
int (*ani3d_2_X_comp_internal_bounsurf) (int, double, double, double*, double*, double*) = NULL;
void (*ani3d_2_X_comp_internal_v_u) (int, double, double*) = NULL;

int set_surface_size_function(double (*f) (double, double, double)) {
    ani3d_2_X_comp_internal_fsize = f;
    return 0;
}
int set_param_functions(int (*bounsurf) (int, double, double, double*, double*, double*), void (*v_u) (int, double, double*)) {
    ani3d_2_X_comp_internal_bounsurf = bounsurf,  ani3d_2_X_comp_internal_v_u = v_u;
    return 0;
}
...
int surface_boundary_ (
    ...
    return ani3d_surface_boundary_uni (
	    ...
	    *pnLine, LineD, LineP, LineT,
	    *pnSurface, SurfL, SurfI, SurfT,
	    ani3d_2_X_comp_internal_v_u,
	    ani3d_2_X_comp_internal_bounsurf,
	    NULL,
	    NULL,
...
int polyhedron_make_front (int *pnV, double *vertex, int nS, int *nE, int **edge, int *color1, int *color2, int *pnF, int *face, int *facematerial, int nnV, int nnF) {
    return ani3d_polyhedron_make_front (
	    pnV, vertex, nS, nE, edge, color1, color2,
	    ani3d_2_X_comp_internal_fsize,
	    pnF, face, facematerial, nnV, nnF);
}
