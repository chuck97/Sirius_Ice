...
int scg_make_sphere_colored (int *pnV, int *pnF, double *Vertex, int *Index, int *Color, double x, double MS)
{
	...
	*pnV = 0, *pnF = 0;
	...
	if (Color)  for (i = 0; i < (*pnF); i++)  Color[i] = facematerial[i];
...
{
	return  scg_make_sphere_colored(pnV, pnF, Vertex, Index, NULL, x, MS);
}
...
nL++;
int scg_make_paral_colored (int *pnV, int *pnF, double *Vertex, int *Index, int *Color, double x, double y, double z, double MS)
{
	...
	*pnV = 0, *pnF = 0;
	...
	ADDFACE (2, 4,  *pnV+5, *pnV+6, *pnV+7, *pnV+8);
	ADDFACE (3, 4,  *pnV+1, *pnV+2, *pnV+6, *pnV+5);
	ADDFACE (6, 4,  *pnV+2, *pnV+3, *pnV+7, *pnV+6);
	ADDFACE (4, 4,  *pnV+3, *pnV+4, *pnV+8, *pnV+7);
	ADDFACE (5, 4,  *pnV+4, *pnV+1, *pnV+5, *pnV+8);
	*pnV += 8;
...
{
	return  scg_make_paral_colored(pnV, pnF, Vertex, Index, NULL, x, y, z, MS);
}
...
int scg_make_cylinder_colored (int *pnV, int *pnF, double *Vertex, int *Index, int *Color, double r, double h, double MS)
{
	int nnV = 1000000, nnE = 10, nnF = 1000000, nnS = 10;
	int *face = 0, *facematerial = 0;
	double *vertex = 0;
...
{
	return  scg_make_cylinder_colored(pnV, pnF, Vertex, Index, NULL, r, h, MS);
}
