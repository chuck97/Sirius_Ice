...
// ********** END STATIC FUNCTION DECLARATIONS     **********
  ...
  const std::type_info& entity_type_info() const { return typeid(RefEdge); }
...
template <> struct DLIListSorter<RefEdge*>
{
  bool operator()(RefEdge* a, RefEdge* b) { return a->id() < b->id(); }
};
