...
typedef std::multimap<RefEntity*, CubitString> RefEntityNameMap;
typedef std::map<CubitString, RefEntity*> NameRefEntityMap;

struct RefEntityNameMaps
{
  RefEntityNameMap refMap;
  NameRefEntityMap nameMap;
};
...
public:
  ...
  bool print_name_change_warnings() {return printNameChangeWarnings;}
  void print_name_change_warnings(bool new_val) {printNameChangeWarnings = new_val;}
  int num_name_change_warnings() {return numNameChangeWarnings;}
  void num_name_change_warnings(int new_val) {numNameChangeWarnings = new_val;}
