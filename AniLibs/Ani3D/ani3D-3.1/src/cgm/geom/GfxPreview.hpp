...
class CUBIT_GEOM_EXPORT GfxPreview
{
  ...
  // Geometry Drawing Functions
    static void draw_ref_entity(RefEntity* entity, int color = CUBIT_DEFAULT_COLOR_INDEX,
  ...
  // Generic Primitive Drawing Functions
    ...
    static void draw_polygons(int num_points, const double *xyzs, int num_face_points,
  ...
  protected:
    ...
    virtual void p_draw_polygons(int num_points, const double* xyzs, int num_face_points,
