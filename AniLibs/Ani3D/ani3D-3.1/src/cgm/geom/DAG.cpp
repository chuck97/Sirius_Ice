...
//-------------------------------------------------------------------------
CubitStatus DAG::get_children_at_level( TopologyEntity* parent, int level,
...
// Creation Date : 09/16/97
//-------------------------------------------------------------------------
CubitStatus DAG::get_parents_at_level( TopologyEntity* child, int level,
                                       DLIList<TopologyEntity*>& result_set )
{
...
// Creation Date : 09/16/97
//-------------------------------------------------------------------------
CubitStatus DAG::get_children_at_level( DLIList<TopologyEntity*>& parent_list,
                                        int level,
                                        DLIList<TopologyEntity*>& result_set )
{
  assert( level > 0 );
...
// Creation Date : 09/16/97
//-------------------------------------------------------------------------
CubitStatus DAG::get_parents_at_level( DLIList<TopologyEntity*>& child_list,
                                       int level,
                                       DLIList<TopologyEntity*>& result_set )
{
  assert( level > 0 );
