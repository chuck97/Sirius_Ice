...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int SenseEntity::get_parents( DLIList<TopologyEntity*>* list ) const
{
  if (!myParent)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int SenseEntity::get_children( DLIList<TopologyEntity*>* list ) const
{
  if (!myChild)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus SenseEntity::remove_child_link( TopologyEntity* entity_ptr )
{
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus SenseEntity::disconnect_all_parents( DLIList<TopologyEntity*>* list )
{
  if (!myParent)
    return CUBIT_SUCCESS;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus SenseEntity::disconnect_all_children( DLIList<TopologyEntity*>* list )
{
  if (!myChild)
    return CUBIT_SUCCESS;
...
//-------------------------------------------------------------------------
CubitBoolean SenseEntity::query_append_parents( DLIList<TopologyEntity*>& list )
{
...
CubitBoolean SenseEntity::query_append_children( DLIList<TopologyEntity*>& list )
{
