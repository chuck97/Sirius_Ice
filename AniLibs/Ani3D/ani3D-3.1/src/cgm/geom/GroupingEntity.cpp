...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int GroupingEntity::get_parents( DLIList<TopologyEntity*>* list ) const
{
  if (!myParent)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int GroupingEntity::get_children( DLIList<TopologyEntity*>* list ) const
{
  if (!firstSenseEntity)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus GroupingEntity::remove_child_link( TopologyEntity* child_ptr )
{
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus GroupingEntity::disconnect_all_parents( DLIList<TopologyEntity*>* list )
{
  if (!myParent)
    return CUBIT_SUCCESS;
  if (list) 
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus GroupingEntity::disconnect_all_children( DLIList<TopologyEntity*>* list)
{
...
//-------------------------------------------------------------------------
CubitBoolean GroupingEntity::query_append_parents( DLIList<TopologyEntity*>& list )
{
...
CubitBoolean GroupingEntity::query_append_children( DLIList<TopologyEntity*>& list )
{
