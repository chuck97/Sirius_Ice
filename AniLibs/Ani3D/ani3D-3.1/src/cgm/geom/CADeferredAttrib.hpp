...
private:
  ...
  static std::vector<CADeferredAttrib*> allCADeferredAttribs;
    //- list of all CADA's; used in actuate_all function

  static std::vector<CubitAttrib*> unactuatedCAs;
...
public:
  static std::vector<CubitAttrib*> get_unactuated_deferred_attribs() { return unactuatedCAs; }
