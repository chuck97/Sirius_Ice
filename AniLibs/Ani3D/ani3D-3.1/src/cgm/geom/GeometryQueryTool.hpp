...
public :
  ...
  */
  ...
  CubitStatus translate( DLIList<Body*> &bodies,
  ...
  CubitStatus translate( DLIList<BasicTopologyEntity*> &btes,
                         const CubitVector& delta,
  ...
  CubitStatus rotate( DLIList<Body*> &bodies,
  ...
  CubitStatus rotate( DLIList<BasicTopologyEntity*> &btes,
                      const CubitVector& axis, 
                      double degrees,
  ...
  CubitStatus reflect( DLIList<Body*> &bodies,
                       const CubitVector& point,
                       const CubitVector& axis,
  ...
  CubitStatus reflect( DLIList<BasicTopologyEntity*> &btes,
                       const CubitVector& point,
                       const CubitVector& axis,
  ...
  CubitStatus get_point_containment( DLIList<Body*> &body_list,
...
private :
  ...
  void notify_observers_of_transform(DLIList<RefEntity*> &ref_ents,
                                     const CubitTransformMatrix *xform = NULL) const;
