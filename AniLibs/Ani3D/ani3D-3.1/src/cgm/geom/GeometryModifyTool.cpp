...
CubitStatus GeometryModifyTool::create_surface( DLIList<RefVertex*> &vert_list,
                                                Body *&new_body, RefFace *on_surface )
{
...
Body* GeometryModifyTool::create_rectangle_surface( double width, double height, CubitVector plane )
{
  if(0 == gmeList.size())
  {
    PRINT_WARNING("No active geometry engine.\n");
...
Body* GeometryModifyTool::create_circle_surface( double radius, CubitVector plane )
{
  if(0 == gmeList.size())
  {
    PRINT_WARNING("No active geometry engine.\n");
...
//This function gets called after RefEntities have been created
//on TopologyBridges.  It builds up a map from original RefEntity 
//to the copy RefEntity.  Used when copying Bodies, RefFaces, and
//RefEdges.
CubitStatus GeometryModifyTool::create_old_to_new_ref_ent_map( 
