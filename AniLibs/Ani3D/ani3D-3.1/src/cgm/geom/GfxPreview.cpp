...
void GfxPreview::draw_polygons(int num_points, const double* xyzs, int num_face_points,
...
void GfxPreview::draw_surface_facets_shaded(Surface *surf, int color)
{
  ...
  std::vector<double> dcoords(xyzs, xyzs+g_mem.pointListCount*3);
  GfxPreview::draw_polygons(g_mem.pointListCount, &dcoords[0],
