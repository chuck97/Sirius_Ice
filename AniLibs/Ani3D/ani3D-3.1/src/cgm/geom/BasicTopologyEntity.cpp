...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int BasicTopologyEntity::get_parents( DLIList<TopologyEntity*>* list ) const
{
  if (!firstSenseEntity)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
int BasicTopologyEntity::get_children( DLIList<TopologyEntity*>* list ) const
{
  if (!firstGroupingEntity)
    return 0;
...
//-------------------------------------------------------------------------
CubitBoolean BasicTopologyEntity::query_append_parents( DLIList<TopologyEntity*>& list )
{
  if (!firstSenseEntity)
    return CUBIT_FALSE;
...
CubitBoolean BasicTopologyEntity::query_append_children( DLIList<TopologyEntity*>& list )
{
  if (!firstGroupingEntity)
    return 0;
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus BasicTopologyEntity::remove_child_link(TopologyEntity* entity_ptr)
{
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus BasicTopologyEntity::disconnect_all_parents( DLIList<TopologyEntity*>* list )
{
...
// Creation Date : 07/22/03
//-------------------------------------------------------------------------
CubitStatus BasicTopologyEntity::disconnect_all_children( DLIList<TopologyEntity*>* list )
{
