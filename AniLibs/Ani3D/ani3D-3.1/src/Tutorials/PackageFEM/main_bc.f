...
C LOCAL VARIABLEs
      ...
      Real*8   B(4, 4), C(4, 4), G(4), XYP(3, 4)
      Real*8   x, y, z, eBC(1)
...
c     in other words, for the bilinear form <P1, P1>
     ...
     &              label, Dreact, DDATA, IDATA, iSYS, 5,
     &              4, B, ir, ic)
...
c ... impose the Neumann and Robin boundary conditions
      ...
      Do k = 1, 4
         If(lbF(k).GT.0) Then
            ...
            ibc = Dbc(x, y, z, lbF(k), DDATA, IDATA, iSYS, eBC)

            If(ibc.EQ.BC_NEUMANN .OR. ibc.EQ.BC_ROBIN) Then
               label = lbF(k)

               Call fem3Dface(XY1, XY2, XY3, XY4, k, 0,
     &                        IDEN, FEM_P0, IDEN, FEM_P1, 
     &                        label, Dbc, DDATA, IDATA, iSYS, 2, 
     &                        4, G, ir, ic)
            ...
            If(ibc.EQ.BC_ROBIN) Then
               ...
               Call fem3Dface(XY1, XY2, XY3, XY4, k, 0,
     &                        IDEN, FEM_P1, IDEN, FEM_P1, 
     &                        label, DbcRobCoef, DDATA, IDATA, iSYS, 5, 
     &                        4, C, ir, ic)
...
C ======================================================================
      Integer Function Dreact(x, y, z, label, DDATA, IDATA, iSYS, Coef)
      implicit none
      include 'fem3Dtet.fd'
...
C ======================================================================
      Integer Function DbcRobCoef(x,y,z, label, DDATA,IDATA, iSYS, Coef)
      implicit none
      Include 'assemble.fd'
