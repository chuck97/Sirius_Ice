...
c     axes of the diagonal tensor
      ...
      theta = PI / 3
      Call Drotate(DDATA, 1, theta)
      
      theta = PI / 4
      Call Drotate(DDATA, 2, theta)

      theta = PI / 6
      Call Drotate(DDATA, 3, theta)
...
c             and cell-centered pressures  SOLatTets
         Call HMFEMrecoverUP(nv, vrt, nt, tet, material, DDATA, IDATA,
