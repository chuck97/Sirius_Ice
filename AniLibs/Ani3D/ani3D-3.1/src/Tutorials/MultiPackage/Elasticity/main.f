...
c ======================================================================
c     data provided for the user subroutine Ddiff used in FEM3Dext
      DDATA(1) = 3D0  ! Lame coefficient M
      DDATA(2) = 1D0  ! Lame coefficient L
      IDATA(1) = 2    ! length of DDATA
c ======================================================================
...
c  ...  mark the Dirichlet points via labelP. 
         ...
         Do i = 1, nb
            If(labelF(i).EQ.1 .OR. labelF(i).EQ.18) Then
               ...
               ibc = Dbc(x, y, z, labelF(i), DDATA, IDATA, iSYS, eBC)
...
c  ===  generate the adaptive mesh
         nEStar   = 25000   ! final number of elements
